...
class canvas {
	...
	*/
	...
	{
		// verifica se a imagem ̩ maior do que o tamanho que deseja redimencionar 
		...
		// Se a imagem tiver a altura e a largura menor que o informado ele ṇo redimensiona
		else
		{
